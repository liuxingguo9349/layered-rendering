...
model_P.load_state_dict(torch.load('H:/layerattention/best_model.pth', map_location=torch.device('cpu')))
...
print(res.size())
torch.save(res, f"F:/gan/che_shi_la/best_layered_rendering_{tar}.pt")
